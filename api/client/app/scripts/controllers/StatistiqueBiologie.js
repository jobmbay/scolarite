...
angular.module('scolariteApp')
  .controller('StatBiologieCtrl', function ($scope, $http) {
    ...
    $scope.selectNiveau=function(){
        if ($scope.stat.niveau=="Choix Niveau")
            $scope.affiche.niveau=true;
        else
             $scope.affiche.niveau=false;
         console.log($scope.affiche.niveau);
        }
    $scope.selectOption=function(){
        if ($scope.stat.Option=="Choix Option")
            $scope.affiche.Option=true;
        else
             $scope.affiche.Option=false;
         console.log($scope.affiche.Option);
        }
    $scope.selectFormation=function(){
        if ($scope.stat.Formation=="Choix Formation")
            $scope.affiche.formation=true;
        else
             $scope.affiche.formation=false;
         console.log($scope.affiche.Formation);
        }
    ...
    $scope.selectGraph=function(){
        if ($scope.stat.Graph0=="Diagramme Circulaire"){
         ...
         console.log($scope.affiche.Graph0);
         }
        ...
        if ($scope.stat.Graph0=="Diagramme en barre"){
         ...
         console.log($scope.affiche.Graph1);
         }
    ...
    $scope.AfficheGraph=function(){
         ...
         console.log($scope.affiche.graph);
        }
    $scope.AffichTableau=function(){
             $scope.affiche.graph=false;
             $scope.affiche.Tab=true;             
         console.log($scope.affiche.AffichTableau);
        }
