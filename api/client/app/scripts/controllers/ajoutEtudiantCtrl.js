...
angular.module('scolariteApp')
  .controller('ajoutEtudiantCtrl', function (API_URL,$scope,$http) {
  	...
  	$scope.getOption=function(){
	  	$http.get(API_URL + '/departement/' + $scope.etudiant.departement + '/options').then(function(data){
	...
	$scope.inscription=function(){
		$http.post(API_URL + '/etudiant',$scope.etudiant).then(function(){
			$http.post(API_URL + '/classe',$scope.classe).then(function(){
				$scope.etudiant={};
				$scope.classe={};
			},function(){
				console.log(data);
    ...
    $scope.uploadExcel=function(){
      ...
      $scope.importation=true;
    }
    $scope.saveExcel=function(){
      document.getElementById('submitExcel').click();
      $scope.importation=false;
    }
